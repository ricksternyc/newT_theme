    ...
    <section id="section-2">
        <div class="container-fluid trick-out">  
            ...
            <div class="row card_center">
                <div class="col-xs-6 col-lg-6 card_bounce">
                    <div class="card">
                        <div class="card_images_container">
                        <img class="card-img-top img-fluid" src="<?php the_field('card_img_1'); ?>" alt="Card image cap">
                        
                        <img class="image_circle text-center" src="<?php the_field('card_img_2'); ?>" alt="Owner">
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><?php the_field('paragraph_left'); ?> </p>
                             ...
                             <a href="<?php echo site_url(); ?>/services"><button type="button" class="btn btn btn-success">SERVICES</button></a>
